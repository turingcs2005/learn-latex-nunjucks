...
\noindent
\textbf{Policy Holder:} Test Person \\
\textbf{Policy Number:} SYM-A12345C-00 \\
\textbf{Effective Dates:} 5/1/2023 to 5/1/2024
}

\newcommand{\PIAmt}{\$500,000}
\newcommand{\PIRate}{}
\newcommand{\PIPremium}{\$7,372}
...
Falmouth, MA 02540
 \\
    \\
    \textbf{2. Policy Period:} Noon, standard time at place of issuance from \> \> 5/1/2023 to 5/1/2024 \\
    \\
...
\begin{tabular}{ | A{0.3\CovTbWidth} | A{0.25\CovTbWidth} | A{0.2\CovTbWidth} | A{0.1\CovTbWidth} | A{0.15\CovTbWidth} | }
    ...
    \multicolumn{2}{ |A{0.55\CovTbWidth}| }{\textbf{Form Numbers of Endorsements} forming part of policy at issue (Insert No. and edition date) PF01, PIC02, LOU03, SRV04, CB05, ER06, VC08, DOT09, TES10, DT11, ET12, BOW13, GC14, DD15, WQIS} & \multicolumn{2}{ A{0.3\CovTbWidth}| }{\textbf{Total Premium}} & \$15,927 \\
    \hline
\end{tabular}
\end{center}
...
\hline
\multicolumn{2}{ |A{0.35 \VesselTbWidth}| }{5.(a) Schedule of Vessels} & \multicolumn{4}{A{0.65\VesselTbWidth}| }{AMOUNTS OR LIMITS OF INSURANCE} \\
\hline
...
\begin{tabbing}
    ...
    Assured: \> Test Person \\
    \\
    Whose address is: \> 1 Whalmouth Ln \\
     \> 
Falmouth, MA 02540
 \\
    \\
    ...
    From \> 5/1/2023 \\
    Until \> 5/1/2024 at noon Standard Time at place of issuance \\
\end{tabbing}
...
\centerbold{\Large \uline{LOSS OF USE ENDORSEMENT }}
\extramarks{}{}
\noindent Please note that:
\begin{enumerate}
    \item Coverage: In consideration of a premium of \$ VALUE Incl, if, in consequence of loss, damage or occurrence covered under the Taylor Hull Form (SP-36C) an insured vessel is unable to perform the activity of commercial fishing, this insurance shall provide the Assured with a per diem payment for loss of use of the insured vessel.
...
\extramarks{\policyheader}{}
\centerbold{\Large THIS ENDORSEMENT CHANGES THE COVERAGE. PLEASE READ IT CAREFULLY}
\centerbold{\Large \uline{STRIKES, RIOTS, \& VANDALISM COVERAGE }}
\extramarks{}{}
...
\extramarks{\policyheader}{}
\centerbold{\Large THIS ENDORSEMENT CHANGES THE COVERAGE. PLEASE READ IT CAREFULLY}
\centerbold{\Large \uline{EXTENDED RADIOACTIVE CONTAMINATION EXCLUSION CLAUSE WITH U.S.A. ENDORSEMENT (AIMU - MARCH 1, 2003) }}
\extramarks{}{}
This clause shall be paramount and shall override anything contained in this insurance inconsistent therewith.

\begin{enumerate}[label*=\arabic*]
    \item In no case shall this insurance cover loss damage liability or expense directly or indirectly caused by or contributed to, by or arising from:
        \begin{enumerate}[label*=.\arabic*]
        \item ionizing radiations from or contamination by radioactivity from any nuclear fuel or from any nuclear waste or from the combustion of nuclear fuel.
        \item the radioactive, toxic, explosive or other hazardous or contaminating properties of any nuclear installation, reactor or other nuclear assembly or nuclear component thereof.
        \item any weapon or device employing atomic or nuclear fission and/or fusion or other like reaction or radioactive force or matter.
        \item the radioactive, toxic, explosive or other hazardous or contaminating properties of any radioactive matter. The exclusion in this sub-clause does not extend to radioactive isotopes, other than nuclear fuel, when such isotopes are being prepared, carried, stored, or used for commercial, agricultural, medical, scientific or other similar peaceful purposes. 
        \end{enumerate}
\end{enumerate}
\noindent {\large RADIOACTIVE CONTAMINATION EXCLUSION CLAUSE  (U.S.A. ENDORSEMENT)} \newline

\noindent This insurance is subject to the Extended Radioactive Contamination Exclusion Clause (March 1, 2003) provided that:
\begin{itemize}
    \item if fire is an insured peril, and;
    \item where the subject matter insured or, in the case of a reinsurance, the subject matter insured by the original insurance, is within the U.S.A., its islands, onshore territories or possessions, and;
    \item a fire arises directly or indirectly from one or more of the causes detailed in Sub-Clauses 1.1, 1.2, and 1.4 of the Extended Radioactive Contamination Exclusion Clause March 1, 2003 any loss or damage arising directly from that fire shall, subject to the provisions of this insurance (reinsurance), be covered, EXCLUDING however any loss damage liability or expense caused by nuclear reaction, nuclear radiation, or radioactive contamination arising directly or indirectly from that fire. 
\end{itemize}
\remainunchanged
\extramarks{}{ER 06 040114}
...
\extramarks{\policyheader}{}
\centerbold{\Large THIS ENDORSEMENT CHANGES THE COVERAGE. PLEASE READ IT CAREFULLY}
\centerbold{\Large \uline{VESSEL CLAUSES ENDORSEMENT }}
\extramarks{}{}
...
\newpage
 \extramarks{}{} 
\noindent {\large HANOVER OCEAN MARINE CLAIMS INFORMATION}

\hfill

\noindent {\large The following information will expedite the handling of claims and protect your rights under the Hanover Ocean Marine insurance policies.}
...
\textcolor{red}{\textbf{To report a Pollution claim call:}} % change to red?
