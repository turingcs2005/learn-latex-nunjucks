...
Also see: \url{http://wch.github.io/latexsheet/latexsheet.pdf}
...
\normalsize We have to reset the size to ``normal" to keep the rest of the document in our standard size
\end{verbatim}
...
\begin{itemize}
    ...
    \item Left quotes
    \item SOUL package, issues and alternatives
\end{itemize}
...
\TODO{Negative space}
\TODO{setspace package}

\subsection{Tabbing}

\noindent The environment \textit{tabbing} can be used to align text. Note that the \textbf{tabbing} environment is \textbf{not} the same as the \textbf{tabular} environment. The tabbing environment is for creating sections of aligned text, while the tabular environment is for creating tables. This is covered in \TODO{add section reference}
...
\noindent You can also create your own custom columns. This one creates a left-aligned column of a custom width: \TODO{}
